/**
 * @file  PerfSchedulers.hh
 *
 * @brief   DIET PerfScheduler class header
 *
 ...
 *   |LICENSE|
 */
#ifndef _PERFSCHEDULER_HH_
#define _PERFSCHEDULER_HH_
...
#define SORTFUN(compPerf, TIMESINCELASTSOLVE)
  bool						
